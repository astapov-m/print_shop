...
<body>
@foreach($supply_data as $filteredRows)
    ...
    @if(!is_null($filteredRows[8]) && $filteredRows[8] != '-')
        <div>
            ...
            <p style="position: relative; margin-top: -20mm; margin-left: 40mm; font-weight: bold; font-size: 3.2mm;">{{$filteredRows[10]}} {{mb_substr(mb_convert_encoding($filteredRows[5], 'UTF-8', 'UTF-8'), 0, -2) . 'ая'}}, с рисунком, размер {{$filteredRows[3]}}</p>
